...
export const Popup = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-md max-w-[calc(100vw_-_60px)] absolute left-1/2 top-1/2 transform-[translate(-50%,-50%)] bg-background rounded-md overflow-hidden shadow-[0_0_3px_2px_#ffffff20]",
          popupClassName
        )}
      >
        {showHeader && (
